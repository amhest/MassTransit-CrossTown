...
import com.masstransitproject.crosstown.serialization.MessageSerializer;
 ...
 * 
 **/
public interface Endpoint<T extends Object> {
	/**
	 ...
	 *            message to send.
	 */
	void send(SendContext<T> context);
	 ...
	 **/
	void receive(ReceiveHandler<T> receiver, long timeout);
}
