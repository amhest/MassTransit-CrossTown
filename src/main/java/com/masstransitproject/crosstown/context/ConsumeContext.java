 ...
 */
public interface ConsumeContext<T extends Object> extends MessageContext<T> {
	/**
	 ...
	 */
	ReceiveContext<T> getBaseContext();
	 ...
	 *            information
	 */
	void respond(T message, SendHandler<T> contextCallback);
