...
// specific language governing permissions and limitations under the License.
    ...
    public class ReceiveContext extends
        MessageContext implements
        IReceiveContext
    {
        static final Logger _log = org.slf4j.LoggerFactory.getLogger(ReceiveContext.class);
        final List<IPublished> _published;
        final List<IReceived> _received;
        final List<ISent> _sent;
        final boolean _transactional;
        ByteArrayInputStream _bodyStream;
        Stopwatch _timer;
        IMessageTypeConverter _typeConverter;
        final List<FaultAction> _faultActions;
