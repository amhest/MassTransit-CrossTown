...
import com.masstransitproject.crosstown.context.MessageHeadersImpl;
...
public class SendContextImpl<T extends Object> implements SendContext<T> {
	...
	private final MessageHeadersImpl headers = new MessageHeadersImpl();
	...
	private ReceiveContext<T> receiveContext;
	...
	public SendContextImpl(Class<T> declaringMessageType) {
	...
	public SendContextImpl(T message) {
	...
	@Override
	public void setReceiveContext(ReceiveContext<T> receiveContext) {
		this.receiveContext = receiveContext;
	}

	public ReceiveContext<T> getReceiveContext() {
