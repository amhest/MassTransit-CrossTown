...
// specific language governing permissions and limitations under the License.
    ...
    {
//        MessageTrackerFactory getTrackerFactory ();
        IMessageSerializer getSerializer ();
        boolean getCreateMissingQueues ();
        boolean getCreateTransactionalQueues ();
        boolean getPurgeOnStartup ();
        long getTransactionTimeout ();
        boolean getRequireTransactional ();
